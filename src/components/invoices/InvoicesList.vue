    ...
    <table class="table table--card table-hover" v-else-if="invoices && invoices.length > 0">
      ...
      <tbody v-if="invoices">
        ...
        >
          ...
          <td>
            {{ invoice.subTotal | dineroCurrency }}
            <small v-if="invoice.taxTotal"><br />({{ invoice.total | dineroCurrency }})</small>
          </td>
          <td class="text-right text-capitalize">
            <i
              class="material-icons material-icons-round md-18 mr-2 text-warning"
            ...
            >
            <i
              class="material-icons material-icons-round md-18 mr-2 text-success"
