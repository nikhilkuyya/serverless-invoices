...
export default class Invoice extends Model {
  ...
  static fields() {
    return {
      ...
      consignee_name: this.attr(''),
      consignee_gstin: this.attr(''),
      consignee_address: this.attr(''),
      consignee_postal_code: this.attr(''),
      consignee_country: this.attr(''),
      consignee_county: this.attr(''),
      consignee_city: this.attr(''),
      consignee_email: this.attr(''),
      consignee_id: this.attr(null),
      consignee: this.belongsTo(Client, 'consignee_id'),
